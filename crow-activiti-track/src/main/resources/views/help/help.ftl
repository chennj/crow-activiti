...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="${request.contextPath}/static/adminlte/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="${request.contextPath}/static/adminlte/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="${request.contextPath}/static/adminlte/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="${request.contextPath}/static/adminlte/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="${request.contextPath}/static/adminlte/dist/img/user2-160x160.jpg" alt="user image" class="offline">
...
<!-- Morris.js charts -->
<script src="${request.contextPath}/static/adminlte/bower_components/raphael/raphael.min.js"></script>
<script src="${request.contextPath}/static/adminlte/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="${request.contextPath}/static/adminlte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="${request.contextPath}/static/adminlte/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<script src="${request.contextPath}/static/adminlte/dist/js/dashboard.js"></script>
