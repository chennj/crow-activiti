            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box bg-aqua">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="progress-description">All tasks include completed and unfinished</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12" >
                    <div class="info-box bg-yellow">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="progress-description">All clients include Closed and open</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box bg-green">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Number of urgent tasks</span>
                            <span class="info-box-number">${messageCount}</span>

                            <div class="progress">
                                <div class="progress-bar" style="width: 100%"></div>
                            </div>
                            <span class="progress-description">High priority tasks</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Simple statistical report</h3>
